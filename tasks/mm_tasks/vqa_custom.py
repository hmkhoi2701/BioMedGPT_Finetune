...
from data.mm_data.vqa_custom_dataset import VqaCustomDataset
...
@dataclass
class VqaCustomConfig(OFAConfig):
...
@register_task("vqa_custom", dataclass=VqaCustomConfig)
class VqaCustomTask(OFATask):
    def __init__(self, cfg: VqaCustomConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = VqaCustomDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
