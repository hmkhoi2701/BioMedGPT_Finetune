...
data_dir=/home/khoihm/khoihm/BiomedGPT/datasets/finetuning
data=${data_dir}/test.tsv,${data_dir}/test.tsv
ans2label_file=/home/khoihm/khoihm/requirements.txt #not used
...
for scale in ${Scale[@]}; do
    ...
    save_dir=../../checkpoints/tuned_checkpoints/VinMimic/${scale}
